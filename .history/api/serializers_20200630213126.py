...
class UserSerializer(FlexFieldsModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", 'username', 'first_name', 'last_name', 'email', 'position', 'branch', 'image']
...
class DonationCustomFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = {
            "id": ['in'],
            "date_of_donation": ['exact', 'icontains', 'gt', 'gte', 'lt', 'lte', 'year', 'month', 'day'],
            "accept_donate": ['exact'],
...
class DonationSerializer(FlexFieldsModelSerializer):
    ...
    class Meta:
        model = Donation
        fields = ['medical_staff', 'patient', 'blood_group', 'date_of_donation', 'accept_donate', 'refuse_information']
    ...
    def validate(self, data):
        ...
        if data['accept_donate'] is False:
            ...
            elif data['refuse_information'] is None or \
                    data['refuse_information'] == "":
...
class DonationDetailSerializer(FlexFieldsModelSerializer):
    ...
    class Meta:
        model = Donation
        fields = ['medical_staff', 'patient', 'date_of_donation', 'accept_donate', 'refuse_information']
...
class PatientCustomFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = {'can_donate': ['exact'],
                  ...
                  'date_of_register': ['exact', 'icontains', 'gt', 'gte', 'lt', 'lte', 'year', 'month', 'day'],
                  'search': ['full_search']
                  }
    ...
    def full_search(self, queryset, name, value):
        ...
        return queryset.filter(
            ...
            Q(pesel__icontains=value) | Q(email__icontains=value) |
...
class DonationForPatientSerializer(serializers.ModelSerializer):
    class Meta:
        model = Donation
        fields = ["id", "date_of_donation", "accept_donate", "refuse_information", "medical_staff"]
...
class PatientSerializers(FlexFieldsModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = ['id', "first_name", 'last_name', 'pesel', 'blood_group', 'gender', 'email',
                  'phone_number', 'date_of_register', 'registered_by'
                  ] + ['can_donate'] + ['donation_set']
